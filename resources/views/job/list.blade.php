                    ...
                    <tbody class="divide-y divide-gray-200">
                        @foreach ($jobs as $job)
                            <tr class="hover:bg-gray-50 transition-colors">
                                ...
                                <td class="px-4 py-3 text-center">R$ {{ \App\Enums\SalaryEnum::tryFrom($job->salary)?->description() }}</td>
                                <td class="px-4 py-3 text-center">{{ \App\Enums\PeriodEnum::tryFrom($job->period)?->description() }}</td>
                                <td class="px-4 py-3 text-center">{{ \App\Enums\CategoryEnum::tryFrom($job->category)?->description() }}</td>
